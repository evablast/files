...
*/
  ...
  try {
    ...
    MSGFUNC_PAGE_TRANSLATED_TO = function (a) {
      return "Google heeft deze pagina automatisch vertaald in het: " + a;
    };
    G[3] = MSGFUNC_PAGE_TRANSLATED_TO;
    MSGFUNC_TRANSLATED_TO = function (a) {
      return "Vertaald in: " + a;
    };
    G[4] = MSGFUNC_TRANSLATED_TO;
    MSG_GENERAL_ERROR =
      "Fout: de server kan je verzoek niet verwerken. Probeer het later opnieuw.";
    G[5] = MSG_GENERAL_ERROR;
    MSG_LEARN_MORE = "Meer informatie";
    G[6] = MSG_LEARN_MORE;
    MSGFUNC_POWERED_BY = function (a) {
      return "Mogelijk gemaakt door " + a;
    };
    G[7] = MSGFUNC_POWERED_BY;
    MSG_TRANSLATE_PRODUCT_NAME = "Translate";
    G[8] = MSG_TRANSLATE_PRODUCT_NAME;
    MSG_TRANSLATION_IN_PROGRESS = "Vertaling wordt verwerkt";
    G[9] = MSG_TRANSLATION_IN_PROGRESS;
    MSGFUNC_TRANSLATE_PAGE_TO = function (a) {
      return "Deze pagina vertalen in het " + a + " via Google Translate?";
    };
    G[10] = MSGFUNC_TRANSLATE_PAGE_TO;
    MSGFUNC_VIEW_PAGE_IN = function (a) {
      return "Deze pagina bekijken in het: " + a;
    };
    G[11] = MSGFUNC_VIEW_PAGE_IN;
    MSG_RESTORE = "Origineel tonen";
    G[12] = MSG_RESTORE;
    MSG_SSL_INFO_LOCAL_FILE =
      "De content van dit lokale bestand wordt via een beveiligde verbinding ter vertaling naar Google verzonden.";
    G[13] = MSG_SSL_INFO_LOCAL_FILE;
    MSG_SSL_INFO_SECURE_PAGE =
      "De content van deze beveiligde pagina wordt via een beveiligde verbinding voor vertaling naar Google verzonden.";
    G[14] = MSG_SSL_INFO_SECURE_PAGE;
    MSG_SSL_INFO_INTRANET_PAGE =
      "De content van deze intranetpagina wordt via een beveiligde verbinding ter vertaling naar Google verzonden.";
    G[15] = MSG_SSL_INFO_INTRANET_PAGE;
    MSG_SELECT_LANGUAGE = "Selecteer een taal";
    G[16] = MSG_SELECT_LANGUAGE;
    MSGFUNC_TURN_OFF_TRANSLATION = function (a) {
      return "Vertaling uit het " + a + " uitzetten";
    };
    G[17] = MSGFUNC_TURN_OFF_TRANSLATION;
    MSGFUNC_TURN_OFF_FOR = function (a) {
      return "Uitzetten voor: " + a;
    };
    G[18] = MSGFUNC_TURN_OFF_FOR;
    MSG_ALWAYS_HIDE_AUTO_POPUP_BANNER = "Altijd verbergen";
    G[19] = MSG_ALWAYS_HIDE_AUTO_POPUP_BANNER;
    MSG_ORIGINAL_TEXT = "Originele tekst:";
    G[20] = MSG_ORIGINAL_TEXT;
    MSG_FILL_SUGGESTION = "Een betere vertaling bijdragen";
    G[21] = MSG_FILL_SUGGESTION;
    MSG_SUBMIT_SUGGESTION = "Bijdragen";
    G[22] = MSG_SUBMIT_SUGGESTION;
    MSG_SHOW_TRANSLATE_ALL = "Alles vertalen";
    G[23] = MSG_SHOW_TRANSLATE_ALL;
    MSG_SHOW_RESTORE_ALL = "Alles herstellen";
    G[24] = MSG_SHOW_RESTORE_ALL;
    MSG_SHOW_CANCEL_ALL = "Alles annuleren";
    G[25] = MSG_SHOW_CANCEL_ALL;
    MSG_TRANSLATE_TO_MY_LANGUAGE = "Delen vertalen naar mijn taal";
    G[26] = MSG_TRANSLATE_TO_MY_LANGUAGE;
    MSGFUNC_TRANSLATE_EVERYTHING_TO = function (a) {
      return "Alles vertalen naar het " + a;
    };
    G[27] = MSGFUNC_TRANSLATE_EVERYTHING_TO;
    MSG_SHOW_ORIGINAL_LANGUAGES = "Originele talen tonen";
    G[28] = MSG_SHOW_ORIGINAL_LANGUAGES;
    MSG_OPTIONS = "Opties";
    G[29] = MSG_OPTIONS;
    MSG_TURN_OFF_TRANSLATION_FOR_THIS_SITE =
      "Vertaling voor deze site uitzetten";
    G[30] = MSG_TURN_OFF_TRANSLATION_FOR_THIS_SITE;
    G[31] = null;
    MSG_ALT_SUGGESTION = "Alternatieve vertalingen tonen";
    G[32] = MSG_ALT_SUGGESTION;
    MSG_ALT_ACTIVITY_HELPER_TEXT =
      "Klik op de bovenstaande woorden voor alternatieve vertalingen";
    G[33] = MSG_ALT_ACTIVITY_HELPER_TEXT;
    MSG_USE_ALTERNATIVES = "Gebruiken";
    G[34] = MSG_USE_ALTERNATIVES;
    MSG_DRAG_TIP =
      "Sleep met de Shift-toets ingedrukt om de woordvolgorde te veranderen";
    G[35] = MSG_DRAG_TIP;
    MSG_CLICK_FOR_ALT = "Klik voor alternatieve vertalingen";
    G[36] = MSG_CLICK_FOR_ALT;
    MSG_DRAG_INSTUCTIONS =
      "Houd de Shift-toets ingedrukt en sleep de bovenstaande woorden om ze in de gewenste volgorde te zetten.";
    G[37] = MSG_DRAG_INSTUCTIONS;
    MSG_SUGGESTION_SUBMITTED =
      "Bedankt dat je een suggestie voor de vertaling hebt verzonden naar Google Translate.";
    G[38] = MSG_SUGGESTION_SUBMITTED;
    MSG_MANAGE_TRANSLATION_FOR_THIS_SITE = "Vertalingen beheren voor deze site";
    G[39] = MSG_MANAGE_TRANSLATION_FOR_THIS_SITE;
    MSG_ALT_AND_CONTRIBUTE_ACTIVITY_HELPER_TEXT =
      "Klik op een woord voor alternatieve vertalingen of dubbelklik op een woord om het rechtstreeks te bewerken";
    G[40] = MSG_ALT_AND_CONTRIBUTE_ACTIVITY_HELPER_TEXT;
    MSG_ORIGINAL_TEXT_NO_COLON = "Oorspronkelijke tekst";
    G[41] = MSG_ORIGINAL_TEXT_NO_COLON;
    G[42] = "Translate";
    G[43] = "Vertalen";
    G[44] = "Je correctie is verzonden.";
    MSG_LANGUAGE_UNSUPPORTED =
      "Fout: de taal van de webpagina wordt niet ondersteund.";
    G[45] = MSG_LANGUAGE_UNSUPPORTED;
    MSG_LANGUAGE_TRANSLATE_WIDGET = "Widget Language Translate";
    G[46] = MSG_LANGUAGE_TRANSLATE_WIDGET;
    MSG_RATE_THIS_TRANSLATION = "Deze vertaling beoordelen";
    G[47] = MSG_RATE_THIS_TRANSLATION;
    MSG_FEEDBACK_USAGE_FOR_IMPROVEMENT =
      "Je feedback wordt gebruikt om Google Translate te verbeteren";
    G[48] = MSG_FEEDBACK_USAGE_FOR_IMPROVEMENT;
    MSG_FEEDBACK_SATISFIED_LABEL = "Goede vertaling";
    G[49] = MSG_FEEDBACK_SATISFIED_LABEL;
    MSG_FEEDBACK_DISSATISFIED_LABEL = "Slechte vertaling";
    G[50] = MSG_FEEDBACK_DISSATISFIED_LABEL;
    MSG_TRANSLATION_NO_COLON = "Vertaling";
...
//# sourceURL=/_/translate_http/_/js/k=translate_http.tr.nl.vdhk0GhArrQ.O/d=1/rs=AN8SPfosN9kI5IWqIj6K48tfhRK64wmPDA/m=el_conf
// Configure Constants
(function () {
  ...
  (function () {
    ...
    _loadCss(c._ps);
    _loadJs(
      "https://translate.googleapis.com/_/translate_http/_/js/k\x3dtranslate_http.tr.nl.vdhk0GhArrQ.O/d\x3d1/exm\x3del_conf/ed\x3d1/rs\x3dAN8SPfosN9kI5IWqIj6K48tfhRK64wmPDA/m\x3del_main"
    );
    _exportMessages();
